		...
		<div id="content">
			...
			<div class="body-content" style="float: left;">
				<div class="input-with-icon" style="margin-bottom: 15px;">
					<h5 style="margin-top: -15px;"><strong>Info Produk</strong></h5>
					<!-- button -->
					<form action="" method="post">
						<input type="submit" class="btn btn-primary btnHapus" name="edit" value="Edit">

						<!-- Button trigger modal -->
						<input type="button" class="btn btn-primary btnHapus" data-toggle="modal"
					...
					<div class="card-body">
						...
						<div style="clear: both;">
							...
							<div style="float: right;">
								...
								<p style="font-size:20px;color:#194FB1;" class="right"><b>
										+<?= $data['jumlah'] ?>
									</b></p>
								<?php else: ?>
								<p style="font-size:20px;color:red;" class="right"><b>
										-<?= $data['jumlah'] ?>
									</b></p>
								<?php endif; ?>
							</div>
